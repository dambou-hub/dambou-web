...
export const ALL_MODULES = [
    { type: 'booking', emoji: '\u{1F4C5}', name: 'Réservations', desc: 'Les clients prennent rendez-vous en ligne. Vous recevez une notification et confirmez.', category: 'Client' },
    { type: 'orders', emoji: '\u{1F6D2}', name: 'Module Commandes', desc: "Activez la prise de commandes (click & collect). Un sous-réglage permet d'autoriser les commandes en ligne depuis l'app client.", category: 'Client' },
    { type: 'pos', emoji: '\u{1F4B3}', name: 'Caisse / POS', desc: 'Encaissez vos clients, générez des tickets et suivez vos ventes.', category: 'Gestion' },
    ...
    { type: 'employees', emoji: '\u{1F465}', name: 'Équipe & Employés', desc: 'Gérez vos employés, attribuez des services et suivez les plannings.', category: 'Gestion' },
    { type: 'session_notes', emoji: '\u{1F4CB}', name: 'Notes de séance', desc: 'Rédigez un compte rendu après chaque séance. Historique complet par client, visible uniquement par vous.', category: 'Gestion' },
    { type: 'loyalty', emoji: '\u{1F381}', name: 'Programme de fidélité', desc: 'Récompensez vos clients fidèles avec des points et des avantages.', category: 'Marketing' },
    { type: 'subscriptions', emoji: '\u{1F504}', name: 'Forfaits', desc: 'Vendez des séances en avance à vos clients.', category: 'Marketing' },
    { type: 'ai_assistant', emoji: '\u{1F916}', name: 'Assistant IA', desc: 'Vos clients posent leurs questions en langage naturel et reçoivent une réponse instantanée.', category: 'Marketing' },
    { type: 'stats', emoji: '\u{1F4CA}', name: 'Statistiques avancées', desc: 'Analysez vos performances : CA, clients, services populaires.', category: 'Analyse' },
];
