...
<div class="container">
  ...
  <div class="card">
    ...
    <div class="step">
      ...
      <div class="step-content">
        ...
        <div class="step-desc">Allez dans Modules &rarr; Paiement en ligne &rarr; "Connecter Stripe" pour recevoir vos paiements.</div>
      </div>
    </div>
    <?php endif; ?>
    ...
    <div class="step">
      ...
      <div class="step-content">
        ...
        <div class="step-desc">Commandez votre lecteur WisePad 3 (59&euro;) depuis Modules &rarr; Terminal de paiement.</div>
      </div>
    </div>
    <?php endif; ?>
  ...
  <div class="card">
    ...
    <a href="dambouapp://modules/stripe_payment" class="btn btn-primary">
      Configurer Stripe dans l'app &rarr;
    </a>
    <p style="font-size:11px;color:var(--text-med);text-align:center">
      Ou allez dans Modules &rarr; Paiement en ligne dans l'application
    </p>
  </div>
  <?php endif; ?>
  ...
  <div class="card">
    ...
    <p style="font-size:13px;color:var(--text-med);margin-bottom:16px;line-height:1.5">
      Le lecteur WisePad 3 est vendu 59&euro; directement par Stripe. Il accepte les cartes à puce,
  ...
  <a href="dambouapp://home" class="btn btn-primary">
    Retourner sur l'application &rarr;
  </a>
